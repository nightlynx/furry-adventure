...
Invoke-WebRequest -Uri "https://github.com/nightlynx/furry-adventure/raw/main/Agents/Agent_Install_ALPE.MSI" -Outfile "C:\Agent_Install_ALPE.MSI"
...
powershell.exe start-process -filepath "C:\Agent_Install_ALPE.MSI /qn" -Wait

Remove-Item "C:\Agent_Uninstall.exe"
Remove-Item "C:\Agent_Install_ALPE.MSI"
Remove-Item "C:\Agent_Install_ALPE.ps1"
