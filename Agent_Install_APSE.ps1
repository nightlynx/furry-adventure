...
Invoke-WebRequest -Uri "https://github.com/nightlynx/furry-adventure/raw/main/Agents/Agent_Install_APSE.MSI" -Outfile "C:\Agent_Install_APSE.MSI"
...
powershell.exe start-process -filepath "C:\Agent_Install_APSE.MSI /qn" -Wait

Remove-Item "C:\Agent_Uninstall.exe"
Remove-Item "C:\Agent_Install_APSE.MSI"
Remove-Item "C:\Agent_Install_APSE.ps1"
